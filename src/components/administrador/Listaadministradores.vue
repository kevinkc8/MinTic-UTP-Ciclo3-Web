    ...
    <div class="table-responsive">
        <div class="table-wrapper">
            ...
            <table class="table table-striped table-hover">
              ...
              >
              <v-btn
                @click="btnActualizar(usuario._id,usuario.idDocumentoUsu,usuario.nombre,usuario.apellido,usuario.rol,usuario.telefono,usuario.email,usuario.clave)"
...
<div class="container register">
                <div class="row">
                    <div class="col-md-3 register-left">
                             <h3 class="register-heading">Registrar Administrador</h3>
    ...
    <v-form ref="form" v-model="valid" lazy-validation>
     <v-text-field
      ...
      ></v-checkbox>
       ...
       <v-btn v-if="id==null" color="primary" class="btnRegister" @click="insertarUsuario()">Registrar</v-btn>



      <v-btn v-if="id!=null" color="primary" class="btnRegister" @click="actualizarUsuario(id)"> Actualizar </v-btn>
...
export default {
  ...
  eliminarUsuario(id) {
    ...
    actualizarUsuario(id){
      ...
      btnActualizar(id, idDocumentoUsu, nombre, apellido, rol, telefono, email, clave){
      this.id = id;
